...
//로그인 유저
TuneInUser userNow =  new TuneInUser();
...
int dropdownValueNumber = 10;
int searchPageCounter = 0;
List searchPageUQPList = [];
//searchInit
int searchPageUQPCount = 0;

Stream<QuerySnapshot>? currentStream = FirebaseFirestore.instance
    .collection("uqpPost")
    .orderBy('Time', descending: true).snapshots();
Query current = FirebaseFirestore.instance
    .collection("uqpPost")
    .orderBy('Time', descending: true)
    .limit(10);

var pageQuerySnapshot = FirebaseFirestore.instance
    .collection("uqpPost")
    .orderBy('Time', descending: true)
    .limit(10).snapshots();
