...
class _SignUpPageState extends State<SignUpPage> {
  ...
  bool _toastSignUpIsNull() {
    ...
    if(basicImageUrl.length == 0){
      basicImageUrl = FirebaseAuth.instance.currentUser!.photoURL!;
      _imageUrlController = FirebaseAuth.instance.currentUser!.photoURL!;
    }
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton(
                        ...
                        onChanged: ( newValue) {
                          setState(() {
                            _roleController = newValue.toString();
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        onChanged: ( newValue) {
                          setState(() {
                            positionController = newValue.toString();
                          });
                        },
                        items: positionList
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton(
                        ...
                        onChanged: ( newValue) {
                          setState(() {
                            _addressController = newValue.toString();
                          });
                        },
                      ),
                    ),
